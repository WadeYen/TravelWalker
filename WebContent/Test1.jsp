...
<c:set var="locationList" value="${locationList}" scope="application"/>
...
request.setAttribute("arrays", names);--%>
...
<jsp:useBean id="kuma" class="wade.ScheduleBean"/>
	...
	<body>
	<%String [] t =(String[])request.getSession().getAttribute("schedule"); %>
	...
	<%--=t[0] --%>
			...
			<c:forEach var="kk"  items="${locationList}">
					<button type="button" class="btn btn-light" >
  					...
  					<input type ='hidden' name="locaName" value="${kk.locationName}">
  					<button type="button" class="btn btn-primary" data-toggle="modal" 
  											data-target="#locationName" role="button" >Change Location</button>
